...
public class ServicioControllerV2 {
    ...
    public ResponseEntity<EntityModel<ServicioResponseDTO>> createServicio(@RequestBody ServicioRequestDTO dto) {
    ...
    public ResponseEntity<EntityModel<ServicioResponseDTO>> updateServicio(@PathVariable Long id, @RequestBody ServicioRequestDTO dto) {
